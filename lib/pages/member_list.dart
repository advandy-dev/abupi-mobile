...
class _MemberListScreen extends State<MemberListScreen> {
  ...
  static final List<MemberList> _memberList = [
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Adi-Guna-Putera.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/08/Adiguna-Global-Mandiri.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/PT-AGUNG-PRIMA-NUSANTARA.jpg',
      address: 'Jl Bungur Besar Raya no 85 A, Kemayoran - Jakarta Pusat',
      website: 'https://www.apnhms.com/'
    ),
    MemberList(
      name: 'PT. ALUR MENTAYA SEJAHTERA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/Screenshot-2025-03-03-084144.png',
      address: 'Jl. Pelita No. 87, Kel. MB. Hilir, Kec. MB. Ketapang, Sampit, Kalimantan Tengah'
    ),
    MemberList(
      name: 'PT. AMBANG BARITO NUSAPERSADA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Ambang-Barito-Persada.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Andika-Andalan-Tama.jpg',
      address: 'Jl. Kebon Bawang V No. 8, Tanjung Priok, Jakarta 14320',
      website: 'http://www.andalantama.com/'
    ),
    MemberList(
      name: 'PT. AQUILA TRANSINDO UTAMA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/08/QQUILA.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Bandar-Bakau-Jaya.jpg',
      address: 'Jl. Lintas Timur Piluk, Desa Bakauheni, Lampung Selatan'
    ),
    MemberList(
      name: 'PT. BANDAR TEGUH ABADI',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Bandar-Teguh-Abadi.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Berlian-Manyar-Sejahtera.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Berlian-Pemanduan-Indonesia.jpg',
      address: 'Equity Tower Lantai 35, Jl. Jend. Sudirman Kav. 52 – 53 SCBD, Jakarta Selatan'
    ),
    MemberList(
      name: 'PT. BIAS DELTA PRATAMA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Bias-Delta-Pratama.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/LOGO-PT-BIR.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/06/LOGO-BAT.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Bosowa.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/BAL.jpg',
      address: 'Atria @Sudirman Lt. 4, Jl. Jend. Sudirman Kav. 33A, Jakarta Pusat – 10220'
    ),
    MemberList(
      name: 'PT. CHANDRA ASRI PACIFIC TBK',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Candra-Sari.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/07/chandra-cilegon-port.jpg',
      address: 'Wisma Barito Pacific Tower A Lt. 7, Jl. Letjen S. Parman Kav. 62-63, Jakarta Barat',
      website: 'https://www.chandra-asri.com/'
    ),
    MemberList(
      name: 'PT. CHANDRA PELABUHAN NUSANTARA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/07/chandra-pelabuhan-nusantara.jpg',
      address: 'Wisma Barito Pacific Tower A Lt. 7, Jl. Letjen S. Parman Kav. 62-63, Jakarta Barat',
      website: 'https://www.chandra-asri.com/'
    ),
    MemberList(
      name: 'PT. CIKARANG INLAND PORT',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Cikarang-Dry-Port-v2.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/Screenshot-2025-03-03-085928.png',
      address: 'Jl. Srikandi, Gang Ontorejo, Kampung Sumber Rejo No. 32'
    ),
    MemberList(
      name: 'PT. DELTA ARTHA BAHARI NUSANTARA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Delta-Arta.jpg',
      address: 'Jl. Ibrahim Zahier No. 181-183, Gresik - Jawa Timur 62111',
      website: 'https://dabn.co.id/'
    ),
    MemberList(
      name: 'PT. DERMAGA EMAS NUSANTARA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/PT-DERMAGA-EMAS-NUSANTARA.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Dire-Pratama.jpg',
      address: 'Bakrie Tower 8th Floor, Rasuna Epicentrum Complex, Jl. HR Rasuna Said, Jakarta Selatan 12940'
    ),
    MemberList(
      name: 'PT. EKA NURI',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/08/PT-Ekanuri.jpg',
      address: 'Jl. Hayam Wuruk No.2EE, Gambir, Jakarta Pusat,'
    ),
    MemberList(
      name: 'PT. GARYBER LINK GROUP',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/11/Garyber-Link-Group.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/06/Logo-PT-Gema-SS.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/PT-HADJI-DINI-PERKASA-e1677142794275.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Hasnur-Group.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Indika-Logistik.jpg',
      address: 'Gedung Mitra Lantai 6, Jl. Jend. Gatot Subroto Kav. 21, Jakarta 12930'
    ),
    MemberList(
      name: 'PT. INDO KONTAINER SARANA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Icon-Sarana.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/06/Logo-Indonesia-MPT.jpg',
      address: 'Jl. Kapt Piere Tendean No. 180 RT 17, Banjarmasin 70231 - Kalimantan Selatan'
    ),
    MemberList(
      name: 'PT. INDONESIAN AIR & MARINE SUPPLY',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Indonesia-Air-Marine-Supply.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Inti-Pratama-Group.jpg',
    ...
    MemberList(
      name: 'PT. JABAL NOR',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Jabal-Nor.jpg',
      address: 'Soho Pancoran Noble 1108, Jl. MT Haryono Kav. 2-3, Jakarta Selatan'
    ),
    MemberList(
      name: 'PT. JALATAMA DUTA MANDIRI',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/WhatsApp-Image-2025-03-03-at-09.02.00_07bd5a2e.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Jakarta-International-Container-Terminal.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Jaya-Investa-Terminal.jpg',
      address: 'Kokan Permata Kelapa Gading Blok B.34, Jl. Boulevard Bukit Gading Raya, Jakarta 14240'
    ),
    MemberList(
      name: 'PT. KAPUAS PRIMA COAL TBK',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Kapuas-Prima-Coal.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Karya-Citra-Nusantara.jpg',
      address: 'Jl. Jaya Pura No. 1 KBN Marunda, Jakarta Utara',
      website: 'https://kcnportmarunda.com/',
    ),
    MemberList(
      name: 'PT. KARYA TERMINAL INDONESIA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/08/LOGO-PT.KTI_.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/05/PT-KAWASAN-BERIKAT-NUSANTARA.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/08/logo-pelabuhan-karimunn.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/New-Logo-KBS-Full-Color-Primary.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Lamongan-Shorebase.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/06/logo-LIB.png',
      address: 'Jl. Komp. Balikpapan Baru Pesona San Fransisco Blok FD-09, Balikpapan, Kalimantan Timur'
    ),
    MemberList(
      name: 'PT. LANGLANG LAJU LAYANG',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Lang-Lang-Laju-Layang.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/MACCAHMA-DHINA-HARTIENDSPIN.jpg',
      address: 'Town House Cipta Land Blok Tulip No. 33A, Batam',
      website: 'https://www.haswarpingroup.co.id/'
    ),
    MemberList(
      name: 'PT. MASTER SEGARA PRIMA',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/01/HORIZONTAL-LIGHT-scaled.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Mitra-Rama-Samudera.jpg',
      address: 'Jl. M. Ridwan Rais no 53, Beji - Depok',
      website: 'https://ptmrs.com/',
    ),
    MemberList(
      name: 'PT. MITRA SAMUDERA KREASI',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/06/Logo-Mitra-Samudera-Kreasi.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/03/LOGO-MUARA-LAJU-LANCAR-FIX-4.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/WhatsApp-Image-2025-03-19-at-11.01.33_02711008.jpg',
      address: 'Jl. Aloon-Aloon Priok No. 27, Perak Barat, Krembangan, Surabaya, Jawa Timur'
    ),
    MemberList(
      name: 'PT. MULTI SARANA TERMINAL',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/08/VUBA.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Pelabuhan-Buana-Reja.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/pbp.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/PELABUHAN-CITRA-MANDIRI-1.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Pelabuhan-Lembar.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Astra-Infra-Port.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Pelabuhan-Rembang-Kencana.jpg',
      address: 'Jl. P. Sudirman No. 75 Ds. Kabongan Kidul, Kabupaten Rembang, Jawa Tengah'
    ),
    MemberList(
      name: 'PT. PELABUHAN SAMUDERA PALARAN',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Samudera-Indonesia.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Pelabuhan-Swangi-Indah.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/05/PT-TALENTA-BUMI.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2020/12/mct-logo.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Pelabuhan-Tiga-Bersaudara.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Pelayaran-Indonesia-Setia.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Peteka-Karya-Samudra.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/PMT.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/11/PT.-SALAM-NUSANTARA-SERVIS.jpg',
      address: 'Jl. H. Syahrin 1-A, Gandaria Utara, Kebayoran Baru, Jakarta Selatan'
    ),
    MemberList(
      name: 'PT. SAMUDRA NUSANTARA BARRU (Perseroda)',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/WhatsApp-Image-2025-03-03-at-09.03.47_c8a9ea08.jpg',
      address: 'Gedung UPTD Pel. Ferry Garongkong, Jl. Mayjend. A. Mattalatta Baru'
    ),
    MemberList(
      name: 'PT. SAMUDERA SIAK',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/12/Logo-Samudera-Siak.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Sarana-Abadi-Lestari.jpg',
      address: 'Graha Niaga, Jl. Rapak Indah No 168, Samarinda 75125',
      website: 'https://salpalaran.com/'
    ),
    MemberList(
      name: 'PT. SARANA CITRANUSA KABIL',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Ciranusa-Kabil.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Sarana-Mitra-Global.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/PT-Sebamban-Terminal-Umum.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/10/WhatsApp-Image-2023-10-09-at-10.49.29_06064c3e.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/11/PT-SENDY-JAYA-PUTRA.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/05/SEGARA-CATUR.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Sekawan-Terminal-Samudra.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Siam-Maspion-Terminal.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/03/Screenshot-2025-03-03-092430.png',
      address: 'Jl. Sultan Syarif Hasyim No. 162, Kec. Siak, Kab. Siak, Provinsi Riau'
    ),
    MemberList(
      name: 'PT. SINAR MAS PONTIANAK',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/12/Logo-Sinar-Mas-Pontianak.jpg',
      address: 'Komplek Pertokoan Grand Panglima Polim, Jl. Panglima Polim No. 65-66 Unit 83, Kebayoran Baru - Jakarta Selatan'
    ),
    MemberList(
      name: 'PT. SINARMAS LDA USAHA PELABUHAN',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2023/02/PT-SINARMAS-LDA-MARITIME.png',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2022/02/Terminal-Borneo-Indonesia.jpg',
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2025/01/tnt.jpg',
      address: 'Jl. Sulung 89 Blok D-2 Surabaya 60174',
    ),
    MemberList(
      name: 'PT. TRIPLE EIGHT ENERGY',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2024/12/logo-triple-eight.png',
      address: 'Gedung Data Print, Jl. Blora No. 276, Jakarta Pusat – 10310',
    ),
    MemberList(
      name: 'PT. TUNAS INTI ABADI',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/Tunas-Into-Abadi.jpg',
      address: 'Gedung TMT 1 Lantai 9, Jl. Cilandak KKO No. 1, Jakarta 12560',
      website: 'https://www.tiacoal.co.id/',
    ),
    MemberList(
      name: 'PT. USAHA MULTI KALBAR',
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/12/Logo-Usaha-Mulia-Kalbar.jpg',
      address: 'Komplek Pertokoan Grand Panglima Polim, Jl. Panglima Polim No. 65-66 Unit 83, Kebayoran Baru - Jakarta Selatan',
    ),
    MemberList(
    ...
    MemberList(
      ...
      imageURL: 'https://www.abupi.or.id/wp-content/uploads/2021/01/World-Terminalindo.jpg',
