...
class _StrategicPartnersScreen extends State<StrategicPartnersScreen> {
  final List<StrategicPartners> _strategicPartners = [
    StrategicPartners(
      imageURL: 'https://cms.abupi.or.id/wp-content/uploads/2026/03/LOGO-INSA-300x282-1.png',
    ...
    StrategicPartners(
      imageURL: 'https://cms.abupi.or.id/wp-content/uploads/2026/03/LOGO-IPERINDO-HITAM-300x80-1.png',
    ...
    StrategicPartners(
      imageURL: 'https://cms.abupi.or.id/wp-content/uploads/2026/03/LOGO-ISAA-300x118-1.png',
      name: 'INDONESIA SHIPPING AGENCIES ASSOCIATION',
      website: 'dppisaa.blogspot.com',
    ),
    StrategicPartners(
      imageURL: 'https://cms.abupi.or.id/wp-content/uploads/2026/03/LOGO-HAPI-300x294-1.png',
      name: 'HIMPUNAN AHLI PELABUHAN INDONESIA',
    ),
    StrategicPartners(
      imageURL: 'https://cms.abupi.or.id/wp-content/uploads/2026/03/LOGO-ALFI-300x268-1.png',
    ...
    StrategicPartners(
      imageURL: 'https://cms.abupi.or.id/wp-content/uploads/2026/03/LOGO-APBMI-300x300-1.png',
    ...
    StrategicPartners(
      imageURL: 'https://cms.abupi.or.id/wp-content/uploads/2026/03/LOGO-INAMPA-300x246-1.png',
