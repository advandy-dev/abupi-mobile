...
class _CompetenceProgramScreenState extends State<CompetenceProgramScreen> {
  ...
  String _getSlugForLanguage(String language) {
    return language == 'en' ? 'work-program-competencies' : 'program-kerja-kompetensi';
  }
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (jsonList.isNotEmpty) {
          ...
          setState(() {
            _pageData = data;
            _title = data['acf']['strategic_title'] ?? 'Kompetensi';
          });
        }
      }
    } catch (e) {
  ...
  Widget build(BuildContext context) {
    ...
    final imageUrl = (acfImage != null && acfImage.toString().isNotEmpty)
        ? acfImage.toString()
        : 'https://placehold.co/600x400/png?text=ABUPI+Kompetensi';
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(
          _title.isEmpty ? 'Kompetensi' : _title,
